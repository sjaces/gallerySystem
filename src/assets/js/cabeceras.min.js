...
function cabeceras(){ 
    ...
    function pintaCabecera(e) {
        ...
        if ("gj" != e) {
            ...
            let urlMancheta = `data/imagenes/manchetas/${TIPOSDELOGOS}/` + e + ".png"
    ...
    function checkLinks(e) {
        for (var a = $("a[cabecera]"), i = 0; i < a.length; i++) {
            var r, c = $('a[cabecera=""]:nth(' + i + ")").attr("href"),
                o = c.split(".es/");
            r = o.length > 1 ? c.split(".es/")[1] : c.split(".com/")[1];
            var t = `https://${e}/${r}`;
            $('a[cabecera=""]:nth(' + i + ")").attr("href", t)
        }
    }
    ...
    function comprobarCookie(e) {
        e = obtenerCookie(e)
    }
    
    function fixFirma(e) {
        console.log("Fixing img", e);
        const a = e.width;
        console.log("Width ", a), console.log("NextElement ", e.nextElementSibling);
        var i = e.nextElementSibling;
        console.log("Firma de foto ", i), i.setAttribute("style", "width:" + a + "px ;display: inline-block; position: relative; margin-top: -20px;")
    }
